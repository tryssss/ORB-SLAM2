...
public:
    ...
    int SearchByProjection(Frame &CurrentFrame, RecentlyFrame *pKF, const set<MapPoint*> &sAlreadyFound, const float th , const int ORBdist)//2
    ...
    int SearchByBoW(RecentlyFrame* pKF,Frame &F, vector<MapPoint*> &vpMapPointMatches)//1
